...
def registrar_entrada(request):
    ...
    if patente_buscada:
        try:
            ...
            messages.error(
                request,
                f'El vehículo con patente {patente_buscada} no está registrado en el sistema. Debe existir para registrar entrada.'
            )
            vehiculo = None
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.error(
                    request,
                    f'El vehículo con patente {patente} no está registrado en el sistema. Debe existir para registrar entrada.'
                )
                context = {
                    'form': form,
                    'vehiculo': None,
            ...
            registro = RegistroAcceso(
                ...
                nombre_chofer=(vehiculo.nombre_chofer or '-'),
                telefono_chofer=vehiculo.telefono_chofer or '',
                empresa_chofer=vehiculo.empresa_chofer or '',
        ...
        # Pre-llenar solo la patente si se buscó
        initial_data = {}
        if vehiculo:
            initial_data = {
