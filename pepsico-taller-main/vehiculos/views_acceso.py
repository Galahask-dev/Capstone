    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.error(
                    request,
                    f'El vehículo con patente {patente} no está registrado en el sistema. Por favor, regístralo primero.'
                )
                return redirect('ingreso_vehiculo')
            ...
            registro = RegistroAcceso(
                ...
                empresa_chofer=form.cleaned_data.get('empresa_chofer', ''),
                kilometraje=vehiculo.kilometraje,  # Usar el kilometraje del vehículo
